 ...
 * @param ctx.enabled - The theme state
 * @param ctx.id - The theme ID to change
 */
function changeTheme({ enabled, id }: ITheme) {
 ...
 *
 * @param ctx - The change context
 * @param ctx.enabled - The font state
 * @param ctx.id - The font ID to change
 */
function changeFont({ enabled, id }: ITheme) {
	// Reset selected and select new one
